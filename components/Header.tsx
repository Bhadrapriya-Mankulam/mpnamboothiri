      ...
      <nav className="container mx-auto px-4 py-3">
        ...
        {mobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden mt-4 pb-4 border-t border-temple-stone-200 bg-white"
          >
            <div className="flex flex-col gap-4 pt-4">
              <Link
                href="/"
                onClick={() => setMobileMenuOpen(false)}
                className="text-deep-indigo-900 hover:text-temple-gold-700 transition-colors font-medium py-2"
              >
                Home
              </Link>
              <Link
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => setMobileMenuOpen(false)}
                className="px-4 py-3 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors font-semibold mt-2 inline-flex items-center justify-center gap-2"
              >
