      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-7xl mx-auto">
          ...
          <div className="relative order-2 lg:order-1">
            ...
            <div className="absolute -bottom-4 -left-4 w-32 h-32 bg-saffron-200 rounded-full blur-2xl opacity-50 -z-10" />
          </div>

          {/* Content */}
          <div className="text-center lg:text-left order-1 lg:order-2">
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-deep-indigo-900 mb-4">
              {siteData.name}
            </h1>
            <p className="text-xl md:text-2xl text-temple-gold-700 font-semibold mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center mb-8">
              <a
                ...
                className="px-6 py-3 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors font-semibold text-base inline-flex items-center justify-center gap-2 w-full sm:w-auto"
              >
              ...
              <a
                ...
                className="px-6 py-3 bg-white text-deep-indigo-900 border-2 border-deep-indigo-900 rounded-md hover:bg-deep-indigo-900 hover:text-white transition-colors font-semibold text-base inline-flex items-center justify-center gap-2 w-full sm:w-auto"
              >
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-3">
              <span className="px-3 py-1.5 bg-temple-gold-100 border border-temple-gold-300 rounded-full text-xs text-temple-gold-800 font-medium">
